...
public interface CartService {
    ...
    CartResponse addItemToCartWithValidation(Long userId, AddToCartRequest request);
    
    // Methods for order-service integration
    CartValidationResponse getValidatedCart(Long userId);
}
